...
<link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/zhangzu/images/logo_32X32.ico" media="screen" />
<link href="${pageContext.request.contextPath}/static/css/haiyu.css?ver=1.1" rel="stylesheet" media="screen">
