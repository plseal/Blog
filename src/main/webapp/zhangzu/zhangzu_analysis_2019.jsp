...
$(document).ready(function(){ 
	$('#zhangzu_ac').change(function(){ 
		...
		window.location.href = "<%=request.getContextPath() %>/zhangzu/to_zhangzu_analysis_2019.do?zhangzu_ac="+p1;
	}) 
}) 
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Month', '支出', '收入', '余额', '买货'],
		<c:forEach items="${list_2019_zz_analysis}"  var="zz_analysis"  varStatus="status">
				...
				//['2019/01', 139724, 396398, 256674,0],
				//['2019/02', 299392, 145246, -154146,0],
				//['2019/03', 560947, 549570, -11377,239393],
				//['2019/04', 371730, 396398, 24668,79976]
		...
		function selectHandler() {
		  ...
		  for (var i = 0; i < selection.length; i++) {
			...
			if (item.row != null && item.column != null) {
			  ...
			  //ZHICHU
			  if (item.column == 1) {
				window.location.href = "/Blog/zhangzu/to_zhangzu_analysis_2019.do?zhangzu_ac="+str_ac;
			  }
